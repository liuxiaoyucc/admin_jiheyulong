...
class Contact extends Basic
{
    ...
    public function index(Request $request, Filiale $m_filiale)
    {
        try {
            $param = $request->post();
            $page = $param['page'];
    ...
    public function update(Request $request, Filiale $m_filiale)
    {
        if ($request->isPost()) {
            try {
    ...
    public function create(Request $request, Filiale $m_filiale)
    {
        if ($request->isPost()) {
            try {
                $param = $request->post();
    ...
    public function remove(Request $request, Filiale $m_filiale)
    {
        if ($request->isPost()) {
            try {
    ...
    public function info(Request $request, Filiale $m_filiale)
    {
        try {
